...
rm -f "plot_PIN_AVERAGE CLUSTERING.png"
rm -f "plot_PIN_CONNECTED COMPONENTS.png"
rm -f "plot_PIN_NUMBER OF STARS.png"
rm -f "agents_cash_evolution.png"
rm -f "laplacian.png"
rm -f "plot_PIN_DIAMETER.png"
rm -f "plot_PIN_RADIUS.png"
rm -f "plot_PIN_ECCENTRICITY.png"
rm -f "plot_PIN_CORE NUMBER.png"
rm -f "plot_PIN_MAXIMAL INDEPENDENT SET.png"
rm -f csvs/*
rm -f plots/csvs/*
